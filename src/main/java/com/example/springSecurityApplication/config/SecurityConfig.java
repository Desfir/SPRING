...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                // Указываем что данные страницы доступна все пользователям
                .antMatchers("/authentication/login", "/authentication/registration", "/error", "/img/**", "/product/info/{id}","/static/**","/css/**","/js/**","/product/**","/resources/**","/product/search").permitAll()
